...
class BalanceSheetHierarchy {
  static final List<FinancialNode> roots = [
        ...
        FinancialNode(
          ...
          children: [
            ...
            FinancialNode(
              ...
              alternativeNames: ['IntangibleAssets', 'Net Intangible Assets'],
              category: NodeCategory.nonCurrentAsset,
              type: NodeType.leaf,
            ),
            FinancialNode(
            ...
            FinancialNode(
              ...
              metricName: 'Long-Term Investments',
              alternativeNames: [
        ...
        FinancialNode(
          ...
          children: [
            FinancialNode(
              ...
              alternativeNames: ['AccountsPayable', 'Payables'],
              category: NodeCategory.currentLiability,
              type: NodeType.leaf,
            ),
            FinancialNode(
        ...
        FinancialNode(
          ...
          children: [
            ...
            FinancialNode(
              ...
              metricName: 'Deferred Tax Liabilities',
              alternativeNames: [
    ...
    FinancialNode(
      ...
      metricName: 'Total Stockholder Equity',
      alternativeNames: [
        'Stockholders Equity',
  ...
  static final FinancialNode root = FinancialNode(
    ...
    children: [
      ...
      FinancialNode(
        ...
        alternativeNames: ['Revenue', 'Net Revenue', 'Sales', 'Total Revenue (ttm)'],
        category: NodeCategory.revenue,
        type: NodeType.parent,
        children: [
          FinancialNode(
            ...
            displayName: 'Revenue',
            metricName: 'Revenue',
            alternativeNames: ['Net Sales', 'Operating Revenue'],
            category: NodeCategory.revenue,
            type: NodeType.leaf,
          ),
        ],
      ...
      FinancialNode(
        ...
        children: [
          FinancialNode(
            ...
            metricName: 'Selling General and Administrative',
            alternativeNames: ['SG&A', 'SGA', 'Selling General And Administrative'],
            category: NodeCategory.expense,
            type: NodeType.leaf,
          ),
          FinancialNode(
      ...
      FinancialNode(
        ...
        type: NodeType.calculated,
        calculationType: CalculationType.subtract,
        childMetricNames: ['Income Before Tax', 'Tax Expense'],
      ),
    ],
  );
}
