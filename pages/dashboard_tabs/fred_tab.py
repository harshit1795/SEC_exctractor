...
def render_filters():
    st.markdown("#### Macroeconomic Filters")
    ...
    if selected_indicators:
        ...
        if not fred_df.empty:
            ...
            return {"selected_indicators": selected_indicators, "start_date": start_date, "end_date": end_date, "aggregation_period": aggregation_period, "chart_type": chart_type, "chart_view": chart_view, "fred_df": fred_df}
