...
/**
 * Comprehensive dictionary of financial metric descriptions
...
export function getMetricDescription(metricName: string): string {
  ...
  if (METRIC_DESCRIPTIONS[metricName]) {
    return METRIC_DESCRIPTIONS[metricName];
  }
  
  // Try case-insensitive match
  const lowerName = metricName.toLowerCase();
  for (const [key, value] of Object.entries(METRIC_DESCRIPTIONS)) {
  ...
  if (lowerName.includes('income') || lowerName.includes('profit') || lowerName.includes('earnings')) {
  ...
  if (lowerName.includes('liabilit') || lowerName.includes('debt') || lowerName.includes('payable')) {
  ...
  if (lowerName.includes('equity') || lowerName.includes('stockholder') || lowerName.includes('book value')) {
  ...
  if (lowerName.includes('eps') || lowerName.includes('earnings per share')) {
  ...
  if (lowerName.includes('return') || lowerName.includes('roe') || lowerName.includes('roa')) {
  ...
  if (lowerName.includes('cost') || lowerName.includes('cogs') || lowerName.includes('expense')) {
  ...
  if (lowerName.includes('turnover') || lowerName.includes('days')) {
